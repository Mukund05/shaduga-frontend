...
const LeaderBoard = ({ setOpenSideBar, openSideBar, setProfileCard }) => {
      ...
      {showProfile ? (
        <div className="bg-[#191a1e] relative flex justify-start ">
          ...
          <div className="flex flex-col gap-6 p-4 py-8 bg-[#20212a] h-full w-full sm:w-2/3">
            <div className="flex gap-6 justify-start items-center ps-12 lg:ps-0">
              <img src={avatar} className="w-fit h-fit" />
              <div className="flex justify-between flex-col gap-3 font-semibold">
                <span className="text-white text-md">Azure2000</span>
                <div className="flex gap-x-5 gap-3 lg:gap-x-10 text-[#838383] text-xs justify-start flex-wrap">
                  <span className="">Level 1</span>
                  <span className="">#42976</span>
                  <span className="">0 active invites</span>
                </div>
              </div>
            </div>
            <div className="flex gap-4 justify-start">
              <div className="rounded-2xl p-2 py-1 cursor-pointer flex items-center gap-2 justify-between  bg-[#2D2D2D]">
                <TwitterIcon className="text-[#838383]" />
                <span className="text-[#838383] text-sm">Twitter</span>
              </div>
              <div className="rounded-2xl p-2 py-1 cursor-pointer flex items-center gap-2 justify-between  bg-[#2D2D2D]">
                <img src={discord} className="text-[#838383]" />
        ...
        <div className="bg-[#20212a] relative w-full ">
          ...
          <div className="flex flex-col justify-start gap-5 px-16 lg:px-4 p-4 bg-gradient-to-r from-[#3F0140] to-[#A303A6] -mb-16 pb-20">
            ...
            <span className="px-2 py-1 border-[#05F3DB]  border rounded-2xl flex justify-between gap-3 w-fit text-[#05F3DB]">
          ...
          <div className="rounded-t-3xl bg-[#20212a] ">
            <div className="overflow-x-auto  max-h-screen flex flex-col gap-6 py-6 ">
              <div
                ...
                onClick={() => {
                  setShowProfile(true), setProfileCard(true);
                }}
              >
                <div className=" flex justify-between gap-4">
                  <img src={loggeduser} className="rounded-full w-fit" />
